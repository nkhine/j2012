...
$(function () {
    $('.cube > div').on('mouseup', function () {
        var nav_url = null;
        if (dragging == 0) {
            if ($(this).attr('id') != '1st') {
                switch ($(this).attr('id')) {
                    case '2nd':
                        nav_url = 'https://www.yahoo.com';
                        break;
                    case '3rd':
                        nav_url = 'https://www.microsoft.com';
                        break;
                    case '4th':
                        nav_url = 'https://www.facebook.com';
                        break;
                    case '5th':
                        nav_url = 'https://www.twitter.com';
                        break;
                    case '6th':
                        nav_url = 'https://www.youtube.com';
                        break;
                }
